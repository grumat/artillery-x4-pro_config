...
py -3 gen_stats.py --data=.\data\probe_accuracy_filament.json --out=.\data\probe_accuracy_filament.jpg --title="Probe Accuracy: Rotation + Slow Motion + Filter + Filament" >> Results.txt
py -3 gen_stats.py --data=.\data\probe_accuracy_baolsen.json --out=.\data\probe_accuracy_baolsen.jpg --title="Probe Accuracy: Rotation + Slow Motion + Filter (2026)" >> Results.txt
py -3 gen_stats.py --data=.\data\probe_accuracy_panasonic.json --out=.\data\probe_accuracy_panasonic.jpg --title="Probe Accuracy: Rotation + Slow Motion + Filter + Panasonic (2026)" >> Results.txt
